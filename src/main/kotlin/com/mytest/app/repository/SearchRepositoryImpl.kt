...
@Repository
class SearchRepositoryImpl(@Qualifier("customWebClient") private val webClient: WebClient)
	: SearchRepository{
	 ...
	 * 카카오 검색 API
	 */
	override suspend fun getKakaoSearchResult(keyword: String, page: String, size: String): Mono<KakaoResponse> = coroutineScope {
	 ...
	 * 네이버 검색 API
	 */
	override suspend fun getNaverSearchResult(keyword: String, page: String, size: String): Mono<NaverResponse> = coroutineScope {
